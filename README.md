...
The event managing and game state registration are probably a bit of overkill for what this program is, but I was adopting someone else's approach for setting up an abstract SFML app when I was brand-new to GUI programming. I used the TGUI library to facilitate entering and displaying high scores.
